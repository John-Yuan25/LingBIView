...
let videoStore = useVideoStore(currStore.currStoreId)()
let videoUlrStr = toRef(videoStore, 'videoUrl')
//zindex属性在父组件上
...
function updateComp(e) {
    videoStore = useVideoStore(currStore.currStoreId)()
    videoStore.$patch({
        videoUrl: videoUlrStr.value,
        attribute: [
            {
                name: "宽度",
                type: 'number',
