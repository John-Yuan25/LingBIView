...
let timeStore = useTimeStore(currStore.currStoreId)()
...
function updateComp(e) {
  timeStore = useTimeStore(currStore.currStoreId)()
  timeStore.$patch({
    attribute: [
      {
        name: "宽度",
...
const openEditor = function () {
  currStore.editorCode = timeStore.code;
...
const delectCom = () => {
  if (confirm("确定要删除这个组件吗？")) {
    ...
    //清楚定时器
    clearInterval(timeStore.timer as any)
    //卸载组件
